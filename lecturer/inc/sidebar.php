 <div class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-users text-dark"></i><span class="hide-menu">Student </span></a>
    ...
    <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-user text-primary"></i><span class="hide-menu">Profile</span></a>
        ...
        <li> <a href="logout.php" aria-expanded="false" onClick="return confirm('Are you sure you want to logout ?')"><i class="fa fa-sign-out text-danger"></i><span class="hide-menu">Logout</span></a>
