...
$id=$_GET['id'];
$type=$_GET['type'];
$qk=mysqli_query($con,"select * from learning_content where id='$id' order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card-body">
                                    ...
                                    if ($type=='document') {
                                        ...
                                        <div class="embed-responsive embed-responsive-16by9">
                                              <a class="media" href="document/<?php echo $r['document']; ?>"></a>
                                        </div>
                                        <?php
                                    } elseif ($type=='audio') {
                                        ?>
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="audio/<?php echo $r['audio'] ?>" allowfullScreen></iframe>  
                                        </div>
                                        <?php
                                    } elseif ($type=='video') {
                                        ?>
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="video/<?php echo $r['video'] ?>" allowfullScreen></iframe>  
                                        </div>
                                        <?php
                                    }
