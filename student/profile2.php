...
$x=mysqli_query($con,"select * from student where matno='".$_SESSION['user_id']."'");
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                 <form action="cpass.php" method="POST">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                        <p class="text-muted m-b-15 f-s-12">Matric Number :</p>
                                        <input type="text" class="form-control input-rounded"  value="<?php echo $xx['matno']; ?>" disabled="disabled">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                        <p class="text-muted m-b-15 f-s-12">Admision Year :</p>
                                        <input type="text" class="form-control input-rounded"  value="<?php echo $xx['year']; ?>" disabled="disabled">
                                    </div>
                                    </div>


                                  <br><center><img src="../admin/studentimages/<?php echo $xx['image']; ?>" width="200" height="200"></center>
